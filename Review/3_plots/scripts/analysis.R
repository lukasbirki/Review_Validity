...
rbind(df1 %>% filter(n > 1),df2) %>% 
  ...
  scale_fill_Publication(name = "Category")+
  theme_Publication() +theme(legend.position = "right",legend.direction="vertical") -> barchart_source
...
ggsave(plot =souce_overview ,filename = "Review/3_plots/output/overview_descriptive.png",width = 10, height = 10)
